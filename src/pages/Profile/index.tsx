    ...
    const handleSubmit = useCallback(async (data: ProfileFormData) => {
        try {
            ...
            const schema = Yup.object().shape({
                ...
                email: Yup.string().required('E-mail obrigatoria').email('Digite um e-mail valido'),
        ...
        <Container>
            ...
            <Content>
                <Form ref={formRef} initialData={{
                    ...
                    <Input name="password" icon={FiLock} type="password" placeholder="Nova atual" />
                    <Input name="password_confirmation" icon={FiLock} type="password" placeholder="Confirmat senha" />
